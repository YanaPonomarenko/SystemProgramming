...
//HW 20.03
    class Program
    {
        ...
        {
            Console.WriteLine(" 1- Lowest, Normal, Highest\n");
            ...
            Console.WriteLine("\n\n 2- Highest, Normal, Lowest\n");

            threadLow = new Thread(PrintLow);
            threadNormal = new Thread(PrintNormal);
            threadHigh = new Thread(PrintHigh);
